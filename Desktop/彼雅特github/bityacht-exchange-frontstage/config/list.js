export const yearsMoneyList = ['AuthVerify.moneyGetOption1', 'AuthVerify.moneyGetOption2', 'AuthVerify.moneyGetOption3', 'AuthVerify.moneyGetOption4', 'AuthVerify.moneyGetOption5', 'AuthVerify.moneyGetOption6'];
export const getMoneyList = ['AuthVerify.getMoneyWhereOption1', 'AuthVerify.getMoneyWhereOption2', 'AuthVerify.getMoneyWhereOption3', 'AuthVerify.getMoneyWhereOption4', 'AuthVerify.getMoneyWhereOption5'];
export const usePurposeList = ['AuthVerify.usePurposeOption1', 'AuthVerify.usePurposeOption2', 'AuthVerify.usePurposeOption3'];
export const investExpList = ['AuthVerify.investExpOption1', 'AuthVerify.investExpOption2', 'AuthVerify.investExpOption3', 'AuthVerify.investExpOption4', 'AuthVerify.investExpOption5'];
export const cityData = ['臺北市', '新北市', '基隆市', '桃園市', '新竹縣', '新竹市', '苗栗縣', '臺中市', '南投縣', '彰化縣', '雲林縣', '嘉義縣', '嘉義市', '臺南市', '高雄市', '屏東縣', '宜蘭縣', '臺東縣', '花蓮縣', '澎湖縣', '金門縣', '連江縣'];
